...
class PricingSection extends StatelessWidget {
  ...
  Widget _buildVATCalculation(ComprehensiveInventoryProvider provider) {
    final double basePrice =
        double.tryParse(provider.priceController.text) ?? 0;
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                '${provider.selectedCurrency} ${basePrice.toStringAsFixed(2)}',
              ),
            ],
          ),
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                '${provider.selectedCurrency} ${vatAmount.toStringAsFixed(2)}',
              ),
            ],
          ),
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                '${provider.selectedCurrency} ${finalPrice.toStringAsFixed(2)}',
