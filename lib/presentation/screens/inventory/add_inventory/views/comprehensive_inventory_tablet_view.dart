...
/// Comprehensive tablet view for add inventory screen
class ComprehensiveInventoryTabletView extends StatelessWidget {
  const ComprehensiveInventoryTabletView({
